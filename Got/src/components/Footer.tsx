    ...
    <div className="row justify-content-between g-4 mb-5">
      <div className="col-md-4 col-lg-3">
        <div className="d-flex align-items-center gap-2 mb-4">
          ...
          <span className="fw-bold fs-5 text-body tracking-tighter">МИНСК ГАСТРО</span>
        </div>
          ...
          <div className="col-md-7 col-lg-6">
            <div className="row g-4">
              <div className="col-6 col-sm-4">
                <h4 className="fw-bold small text-body-secondary text-uppercase tracking-widest mb-4">Проект</h4>
                <ul className="list-unstyled small">
                  <li className="mb-3"><Link to="/about" className="text-decoration-none text-body hover-danger">О нас</Link></li>
                  <li className="mb-3"><Link to="/catalog" className="text-decoration-none text-body hover-danger">Каталог</Link></li>   
                </ul>
              </div>
              <div className="col-6 col-sm-4">
                <h4 className="fw-bold small text-body-secondary text-uppercase tracking-widest mb-4">Помощь</h4>
                <ul className="list-unstyled small">
                  <li className="mb-3"><Link to="/support" className="text-decoration-none text-body hover-danger">Поддержка</Link></li>
                  <li className="mb-3"><Link to="/contacts" className="text-decoration-none text-body hover-danger">Контакты</Link></li>
                </ul>
              </div>
              <div className="col-12 col-sm-4 d-none d-sm-block">
                <h4 className="fw-bold small text-body-secondary text-uppercase tracking-widest mb-4">Соцсети</h4>
                <div className="d-flex gap-3">
                  ...
                  <img src="src/components/inst_logo.png" alt="Instagram" style={{ width: '30px', height: '30px' }}></img>
                  </a>
        ...
        <div className="pt-4 border-top d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
          ...
          <div className="d-flex gap-4">
            <Link to="/privacy" className="text-decoration-none text-body-secondary small fw-medium hover-body">Политика конфиденциальности</Link>
          </div>
        </div>
      </div>
      <style>{`
