          ...
          <div className="row g-4 mb-5">
            ...
            <div className="col-md-6">
              <div className="bg-light p-5 rounded-4 h-100 border-0">
                ...
                <p className="small mb-0 text-secondary">Честность отзывов, актуальность данных, внимание к пользователям, своевренные рекомендации и ответы на интересующие вопросы.</p>
              </div>
            </div>
          </div>
        </div>
